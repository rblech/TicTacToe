...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            /**Es wird eine neue variable deklariert die status heißt und eine Instanc des TicTacToeViewModel ist*/
            val status : TicTacToeViewModel by viewModels()
            TicTacToeTheme {
                        ...
                        topBar = {
                            TopAppBar(
                                ...
                                actions = {
                                    IconButton(
                                        onClick = {
                                            /**Die status.resetGame() wird aufgerufen aus dem TicTacToeViewModel*/
                                            status.resetGame()
                                        }
                                    ) {
                                        Icon(
